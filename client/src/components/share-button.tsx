...
export function ShareButton() {
  ...
  const shareToTwitter = () => {
    const text = "A heartfelt message for someone special";
  ...
  const shareToWhatsApp = () => {
    const text = "Check out this beautiful message";
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-48">
        <DropdownMenuItem onClick={copyToClipboard} data-testid="button-share-copy">
          {copied ? (
